...
if uploaded_file:
    ...
    if not results.empty:
        for idx, row in results.iterrows():
            ...
            st.write(f"**Сумма долга:** {row['Сумма долга']}")
            st.write(f"**Остаток долга:** {row['Остаток долга']}")
            st.write(f"**Сумма исп. сбора:** {row['Сумма исп. сбора']}")
            st.write(f"**Остаток по исп. сбору:** {row['Остаток по исп. сбору']}")
